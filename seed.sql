...
INSERT INTO plan 
(id, created_at, archived, uuid, title, interval_unit, interval_amount, days_before_first_charge, trial_period_days, description, category_uuid)
VALUES(2, datetime(), 0,  '5813b05b-9031-45b3-b120-8fc6b1b3082e', 'Bath Soaps', 'monthly', 1099, 0, 0, 'This plan has a description', '7085d61d-c84d-4951-a824-aa27c7e21086');

INSERT INTO plan 
(id, created_at, archived, uuid, title, sell_price, days_before_first_charge, trial_period_days, category_uuid)
VALUES(3, datetime(), 0,  '58921f7a-3371-4ccf-aeee-e2b8af5cca3a', 'One-Off Soaps', 566, 0, 0, '7085d61d-c84d-4951-a824-aa27c7e21086');
