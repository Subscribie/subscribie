...
async function test_order_plan_with_free_trial(browsers, browserContextOptions) {
  for (const browserType of browsers) {
    ...
    assert(recuring_charge_content === "Try Free Trial");
    ...
    assert(subscriber_plan_title_content === 'Free Trial');
...
module.exports = test_order_plan_with_free_trial
