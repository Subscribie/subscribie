...
def upgrade():
    ...
    if 'payment_provider' not in tables:
        ...
        sa.Column('stripe_webhook_endpoint_secret', sa.String(), nullable=True),
        sa.Column('stripe_webhook_endpoint_id', sa.String(), nullable=True),
        sa.PrimaryKeyConstraint('id')
        )
    ...
    if 'person' not in tables:
        ...
        sa.Column('password_reset_string', sa.String(), nullable=True),
    ...
    if 'plan_choice_group' not in tables:
        op.create_table('plan_choice_group',
        sa.Column('choice_group_id', sa.Integer(), nullable=True),
    ...
    if 'plan_requirements' not in tables:
        op.create_table('plan_requirements',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('plan_id', sa.Integer(), nullable=True),
    ...
    if 'plan_selling_points' not in tables:
        op.create_table('plan_selling_points',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=True),
